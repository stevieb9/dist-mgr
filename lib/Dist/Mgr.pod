...
[documentation](https://metacpan.org/pod/distribution/Dist-Mgr/bin/distmgr) for
...
I<Returns>: C<0> if the repository differs and C<1> if nothing needs to be done.
...
we'll work on all Perl module files.
